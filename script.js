    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					action_destroyer(forceBounds.call(null, input6, { min: 1, max: 40, store: particle_life })),
    					action_destroyer(forceBounds.call(null, input7, { min: 2, max: 20, store: clr_num })),
    					action_destroyer(forceBounds.call(null, input8, {
    						min: -10,
    						max: 10,
    						store: clr_factor,
    						mustBeInt: false
